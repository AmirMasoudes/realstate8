          ...
          <div className="grid md:grid-cols-2 gap-8 p-8 md:p-12">
            ...
            <div className="flex flex-col justify-center space-y-6 order-2 md:order-1">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#1e3a5f] leading-tight">
                خانه ایده‌آل شما
                <br />
                <span className="text-[#2d5a8f]">منتظر است!</span>
              </h1>
              ...
              <Link
                ...
                className="bg-[#1e3a5f] text-white px-8 py-3 rounded-lg font-semibold 
                                ...
                                shadow-lg hover:shadow-xl w-fit text-center"
              >
                مشاهده املاک
              </Link>
            ...
            <div className="relative flex items-center justify-center min-h-[400px] order-1 md:order-2">
              {/* Location Pin */}
